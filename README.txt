-----DISCLAIMER-----
This is the Hopkins CS B-Team build for the GE CSC Case Study, please don't steal our stuff even though we don't know how to license....
Thankyou!

-------
Objective
-------
Your objective is to create an AI that will solve tetris for as long as possible. We will grade you on number of moves and the amount of time the game lasts. Below is information on the file structure and things you’ll need.
...
You’ll also need an IDE to develop and run the program; we recommend netbeans as that is what we used to make the project.
...
We’ve provided you with a basic AI to begin with: ITLPAI, start there and try to improve upon it. Write your own subclass or to replace the features of the ITLPAI class.
...
•	AI-- simple heuristic logic that knows how to play tetris
•	ITLPAI -- a subclass of AI that uses a brain to play the game without a human player
